...
*NOTE: The structuring of a project will also come to bear in this case. While any structure can be supported by the framework (with some adaptation), I recommend a project structure similar to this:*
